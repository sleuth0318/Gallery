    ...
    private class ShaderProgram(
        ...
        private fun uniformName(name: String): String {
            ...
            val resolved = when {
                ...
                else -> throw VideoFrameProcessingException("TiltShiftEffect: no uniform '$name'")
            }
        ...
        override fun drawFrame(inputTexId: Int, presentationTimeUs: Long) {
            try {
                ...
                glProgram.setFloatsUniform(
                    uniformName("uResolution"), floatArrayOf(width.toFloat(), height.toFloat())
                )
                glProgram.setFloatsUniform(uniformName("uCenter"), floatArrayOf(centerX, 1f - centerY))
                glProgram.setFloatUniform(uniformName("uStrength"), strength)
                glProgram.setFloatUniform(uniformName("uRadius"), 0.55f - 0.30f * strength)
                ...
                throw VideoFrameProcessingException(
                    "TiltShiftEffect: ${t.javaClass.simpleName}: ${t.message}", presentationTimeUs
                )
            }
        }
